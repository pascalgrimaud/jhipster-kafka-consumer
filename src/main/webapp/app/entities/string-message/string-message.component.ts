...
@Component
export default class StringMessage extends mixins(Vue2Filters.mixin) {
  ...
  public totalItems = 0;
  public stringMessages: IStringMessage[] = [];
  ...
  public mounted(): void {
    this.retrieveAllStringMessages();
  }
  ...
  public retrieveAllStringMessages(): void {
