...
@Component
export default class JsonMessage extends mixins(Vue2Filters.mixin) {
  ...
  public totalItems = 0;
  public jsonMessages: IJsonMessage[] = [];
  ...
  public retrieveAllJsonMessages(): void {
